...
INSERT INTO KNJIGA (naslov,naslovna_fotografija,ISBN,datum_objavljivanja,broj_strana,opis,ocena, autor_id) VALUES ('Sta nam svako telo govori','www.slika.com',12345,'2002-09-16',300,'bas dobra knjiga',10.0, 1);
INSERT INTO KNJIGA (naslov,naslovna_fotografija,ISBN,datum_objavljivanja,broj_strana,opis,ocena, autor_id) VALUES ('HARRY POTTER','www.hair_poter.kegenda',19945,'2000-01-11',500,'najjaca knjiga ikada!!!!',9.0, 1);
INSERT INTO KNJIGA (naslov,naslovna_fotografija,ISBN,datum_objavljivanja,broj_strana,opis,ocena, autor_id) VALUES ('Sanja','slika.jpg.com.rs.najjace',1155,'2002-01-11',150,'osnovna skola procitati',0, 1);
INSERT INTO KNJIGA (naslov,naslovna_fotografija,ISBN,datum_objavljivanja,broj_strana,opis,ocena, autor_id) VALUES ('atomske navike','www.nesto.rs',4454,'2019-06-08',200,null,1, 1);
...
INSERT INTO RECENZIJA(ocena,tekst,datum_recenzije, korisnik_id)VALUES (10.0,'sve bajno, sve sjajno. ala je lep ovaj svet ovde potok onde cvet ','2021-04-04', 4);
...
INSERT INTO RECENZIJA(ocena,tekst,datum_recenzije, korisnik_id)VALUES (9.0,'sjajno, mali fali za 10 ','2020-04-24', 2);
...
INSERT INTO STAVKA (knjiga_id, recenzija_id) VALUES (2, 3);
INSERT INTO STAVKA (knjiga_id, recenzija_id) VALUES (4, 2);
...
-- INSERT INTO POLICA_STAVKE (stavke_id, polica_id) VALUES (2, 7);
